...
<html lang="en">
<head>
    <title>Create an Administrator Account</title>
    ...
    <main class="container">
        ...
        <form action="adminAccountCreate.php" method="post">
            <div class="form-group">
                ...
                <input type="text" name="verificationcode" placeholder="Enter Verification Code" id="verificationcode"
                    class="form-control" required>
                <p>If you don't have a verification code, please contact us for one. <a href="contactUs.php">Click Here</a></p>
            ...
            <p>Register as a Regular User? <a href="register.php">Click here</a></p>
        </form>
    </main>
